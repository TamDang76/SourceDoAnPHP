            ...
            <form class="form-horizontal" action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        ...
                        name="name" value="<?php echo $EditAdmin['name'] ?>">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="email" class="form-control" id="inputEmail3" placeholder="Address Email" name="email" value=" <?php echo $EditAdmin['email'] ?>">
